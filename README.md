# RF Eye 0.9.31 for Raspberry Pi

This repository contains the complete **RF Eye 0.9.31 reference appliance** for the MHS35/CUQI-style 3.5-inch SPI touchscreen.
...
The installer reproduces the working 0.9.31 appliance path:
...
RF Eye 0.9.31 uses a **TMB12A03 active buzzer**:
...
`VERSION` and `rfeye/config.py` identify this release as **0.9.31**.
